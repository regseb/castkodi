...
describe("Scraper: LiveLeak", function () {
    it("should return video URL", async function () {
        ...
        assert.ok(file.startsWith("https://cdn.liveleak.com/80281E/ll_a_s" +
                                      "/2018/Aug/28/LiveLeak-dot-com-Untitled" +
                                          "_1535497475.wmv.5b85d54bbb2dd.mp4?"),
                  `"${file}".startsWith(...)`);
    });
    ...
    it("should return video URL even when URL contains 'mp4'",
        ...
        const file = await extract(new URL(url), options);
        assert.ok(file.startsWith("https://cdn.liveleak.com/80281E/ll_a_s" +
                                               "/2018/Oct/19/LiveLeak-dot-com" +
                                  "-LaunchPadWaterDelugeSystemTestatNASAKenn_" +
