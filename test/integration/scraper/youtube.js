...
describe("Scraper: YouTube", function () {
    ...
    it("should return URL when it isn't a video from mobile", async function () {
    ...
    it("should return URL when it isn't a video from music", async function () {
    ...
    it("should return URL when it isn't a playlist", async function () {
    ...
    it("should return URL when it isn't a playlist from mobile", async function () {
        const url = new URL(
