...
describe("Scraper: VTM GO", () => {
    it("should return video UUID from episode", async () => {
        const url = new URL(
    ...
    it("should return video UUID from movie", async () => {
        const url = new URL(
            "https://www.vtmgo.be/vtmgo/afspelen" +
    ...
    it("should return video UUID from movie page", async () => {
        const url = new URL(
