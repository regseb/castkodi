...
<ul>
  ...
  <li>
    YouTube, Twitch, Vimeo, SoundCloud y Acast, Ace&nbsp;Stream, Apple&nbsp;Podcasts, Ausha, Bigo&nbsp;Live, BitChute, Blog&nbsp;Talk&nbsp;Radio, Castbox, Dailymotion, DevTube, Facebook, Flickr, Instagram, ItemFix, Jamendo, Kick, Kickstarter, Mastodon, Megaphone, Mixcloud, Odysee, Overcast, PeerTube, Podcast&nbsp;Addict, podCloud, Prime&nbsp;Video, Radio, Reddit, Rumble, Steam, Streamable, TikTok, Ultimedia, Uqload, Veoh, VideoPress, VidLii, Vidyard, Viously, Vudeo;
    <ul>
...
Para conectar la extensión a Kodi, debe <em>Permitir control remoto desde aplicaciones en otros equipos</em>. Esta opción está en la página <em>Ajustes</em>/<em>Servicios</em>/<em>Control</em> en Kodi. También debes recuperar la <em>Dirección IP</em> de Kodi. Esta información se muestra en la página <em>Ajustes</em>/<em>Información del sistema</em>/<em>Resumen</em>. Luego ingrese esta dirección IP en las <em>Opciones</em> de Cast&nbsp;Kodi.
